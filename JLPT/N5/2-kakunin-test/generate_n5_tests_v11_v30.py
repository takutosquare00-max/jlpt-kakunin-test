...
SENTENCE_QUESTIONS = [
    ...
    ("きのう　＿＿　＿＿　★　＿＿　よみました。", "ほんを", ["としょかんで", "2さつ", "よみました"]),
    ("にちようび　＿＿　＿＿　★　＿＿　いきます。", "バスで", ["こうえんに", "ともだちと", "いきます"]),
    ("わたしは　＿＿　＿＿　★　＿＿　かきます。", "ペンで", ["まいにち", "にっきを", "かきます"]),
    ("わたしは　＿＿　＿＿　★　＿＿　いきます。", "じてんしゃで", ["まいにち", "がっこうに", "いきます"]),
    ("わたしは　＿＿　＿＿　★　＿＿　のみます。", "みずを", ["まいにち", "たくさん", "のみます"]),
    ("わたしは　＿＿　＿＿　★　＿＿　たべます。", "ひるごはんを", ["まいにち", "12じに", "がっこうで"]),
    ("わたしは　＿＿　＿＿　★　＿＿　いきます。", "あるいて", ["まいにち", "えきに", "いきます"]),
    ("わたしは　＿＿　＿＿　★　＿＿　よみます。", "しんぶんを", ["まいにち", "あさ", "よみます"]),
    ("わたしは　＿＿　＿＿　★　＿＿　いきます。", "ちかてつで", ["まいにち", "かいしゃに", "いきます"]),
    ("わたしは　＿＿　＿＿　★　＿＿　たべます。", "ばんごはんを", ["まいにち", "7じに", "いえで"]),
    ("わたしは　＿＿　＿＿　★　＿＿　いきました。", "タクシーで", ["きのう", "えきに", "いきます"]),
    ("わたしは　＿＿　＿＿　★　＿＿　のみます。", "コーヒーを", ["まいにち", "あさ", "きっさてんで"]),
    ("わたしは　＿＿　＿＿　★　＿＿　いきます。", "バスで", ["あした", "びょういんに", "いきます"]),
    ("わたしは　＿＿　＿＿　★　＿＿　かきます。", "てがみを", ["まいにち", "ともだちに", "かきます"]),
]
