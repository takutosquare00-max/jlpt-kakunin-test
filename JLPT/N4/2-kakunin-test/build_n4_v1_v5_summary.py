#!/usr/bin/env python3
"""Merge n4-10min-test-v1..v5 into one HTML, grouped by skill; drop exact duplicate questions."""
...
SOURCES = [DIR / f"n4-10min-test-v{i}.html" for i in range(1, 6)]
OUT = DIR / "n4-kakunin-v1-v5-summary-50.html"
...
def dedupe_globally_ordered(
    ...
    """First occurrence in skill order (もんだい1→6, each v1→v5) wins."""
    seen: set[str] = set()
...
def merged_reading_bundles() -> list[str]:
    """記事は v3+v2+v4 / v1+v5 から結合。設問43〜47は N4 向けに別出題。"""
    q_v3 = _mondai6_first_question(DIR / "n4-10min-test-v3.html")
    q_v2 = _mondai6_first_question(DIR / "n4-10min-test-v2.html")
    q_v4 = _mondai6_first_question(DIR / "n4-10min-test-v4.html")
    q_v1 = _mondai6_first_question(DIR / "n4-10min-test-v1.html")
    q_v5 = _mondai6_first_question(DIR / "n4-10min-test-v5.html")

    soup = BeautifulSoup("", "html.parser")
    b1 = soup.new_tag("div", attrs={"class": "reading-bundle"})
    rp1 = soup.new_tag("div", attrs={"class": "reading-passage"})
    inner1 = (
        _reading_passage_contents(q_v3)
        + "<br/><br/>"
        + _reading_passage_contents(q_v2)
        + "<br/><br/>"
        + _reading_passage_contents(q_v4)
    )
    ...
    _add_reading_question(
        soup,
        b1,
        "\u79cb\u796d\u308a\u306e\u4f1a\u5834\u307e\u3067\u306e\u884c\u304d\u65b9\u3068\u3057\u3066\u3001\u672c\u6587\u3068\u5408\u3063\u3066\u3044\u308b\u3082\u306e\u306f\u3069\u308c\u3067\u3059\u304b\u3002",
        [
            ("1. \u99c5\u304b\u3089\u8eca\u306715\u5206\u3067\u3059", "0"),
            ("2. \u99c5\u304b\u3089\u5f92\u6b69\u306715\u5206\u3067\u3059", "1"),
            ("3. \u5b66\u6821\u306e\u4f53\u80b2\u9928\u3067\u884c\u308f\u308c\u307e\u3059", "0"),
        ...
        "\u2705 \u6b63\u89e3\uff1a2 \u2014 \u672c\u6587\u306b\u300c\u4f1a\u5834\u306f\u99c5\u304b\u3089\u5f92\u6b69\u306715\u5206\u3067\u3059\u300d\u3068\u3042\u308a\u3001\u5165\u5834\u306f\u7121\u6599\u3068\u3082\u66f8\u304b\u308c\u3066\u3044\u307e\u3059\u3002",
    )
    _add_reading_question(
        soup,
        b1,
        "\u6587\u5316\u796d\u306e\u958b\u50ac\u65e5\u3068\u6642\u9593\u3068\u3057\u3066\u3001\u6b63\u3057\u3044\u3082\u306e\u306f\u3069\u308c\u3067\u3059\u304b\u3002",
        [
            ("1. \u4eca\u9031\u306e\u65e5\u66dc\u65e5\u3001\u5348\u524d9\u6642\u304b\u3089\u5348\u5f8c5\u6642\u307e\u3067", "0"),
            ("2. \u6765\u9031\u306e\u571f\u66dc\u65e5\u3001\u5348\u524d10\u6642\u304b\u3089\u5348\u5f8c4\u6642\u307e\u3067", "1"),
            ("3. \u6765\u9031\u306e\u6708\u66dc\u65e5\u3001\u7d42\u65e5", "0"),
            ("4. \u6765\u6708\u306e\u571f\u66dc\u65e5\u306e\u591c\u3060\u3051", "0"),
        ],
        "\u2705 \u6b63\u89e3\uff1a2 \u2014 \u672c\u6587\u306b\u300c\u6765\u9031\u306e\u571f\u66dc\u65e5\u3001\u5b66\u6821\u3067\u300e\u6587\u5316\u796d\u300f\u304c\u3042\u308a\u307e\u3059\u3002\u5348\u524d10\u6642\u304b\u3089\u5348\u5f8c4\u6642\u307e\u3067\u3067\u3059\u300d\u3068\u3042\u308a\u307e\u3059\u3002",
    )
    _add_reading_question(
        soup,
        b1,
        "\u5275\u7acb\u8a18\u5ff5\u65e5\u306e\u6708\u66dc\u65e5\u306b\u3064\u3044\u3066\u3001\u672c\u6587\u3068\u5408\u3063\u3066\u3044\u308b\u3082\u306e\u306f\u3069\u308c\u3067\u3059\u304b\u3002",
        [
            ("1. \u56f3\u66f8\u9928\u306f\u4f11\u307f\u3067\u3059", "0"),
            ("2. \u98df\u5802\u306f\u958b\u3044\u3066\u3044\u307e\u3059", "0"),
            ("3. \u5b66\u6821\u306f\u4f11\u307f\u3067\u3001\u305d\u306e\u65e5\u306f\u5275\u7acb\u8a18\u5ff5\u65e5\u3067\u3059", "1"),
            ("4. \u305d\u306e\u5f8c\u3082\u5b66\u6821\u306f\u305a\u3063\u3068\u4f11\u307f\u3067\u3059", "0"),
        ],
        "\u2705 \u6b63\u89e3\uff1a3 \u2014 \u672c\u6587\u306b\u300c\u6765\u9031\u306e\u6708\u66dc\u65e5\u3001\u5b66\u6821\u306f\u4f11\u307f\u3067\u3059\u3002\u305d\u306e\u65e5\u306f\u300e\u5275\u7acb\u8a18\u5ff5\u65e5\u300f\u3067\u3059\u300d\u3068\u3042\u308a\u3001\u56f3\u66f8\u9928\u306f\u958b\u3044\u3066\u3044\u3066\u98df\u5802\u306f\u4f11\u307f\u3068\u66f8\u304b\u308c\u3066\u3044\u307e\u3059\u3002",
    )
    ...
    inner2 = _reading_passage_contents(q_v1) + "<br/><br/>" + _reading_passage_contents(q_v5)
    ...
    _add_reading_question(
        ...
        "\u2705 \u6b63\u89e3\uff1a2 \u2014 \u672c\u6587\u306b\u300c\u5148\u9031\u306e\u65e5\u66dc\u65e5\u3001\u53cb\u3060\u3061\u3068\u5c71\u306b\u767b\u308a\u307e\u3057\u305f\u300d\u3068\u3042\u308a\u307e\u3059\u3002",
    )
    _add_reading_question(
        soup2,
        b2,
        "\u30b9\u30fc\u30d1\u30fc\u307e\u3067\u306e\u884c\u304d\u65b9\u3068\u3057\u3066\u3001\u672c\u6587\u3068\u5408\u3063\u3066\u3044\u308b\u3082\u306e\u306f\u3069\u308c\u3067\u3059\u304b\u3002",
        [
            ("1. \u81ea\u8ee2\u8eca\u306710\u5206\u3050\u3089\u3044\u3067\u3059", "1"),
            ("2. \u6b69\u3044\u306610\u5206\u3067\u3059", "0"),
            ("3. \u30d0\u30b9\u306715\u5206\u3067\u3059", "0"),
        ...
        "\u2705 \u6b63\u89e3\uff1a1 \u2014 \u672c\u6587\u306b\u300c\u30b9\u30fc\u30d1\u30fc\u306f\u5bb6\u304b\u3089\u81ea\u8ee2\u8eca\u306710\u5206\u3067\u3059\u300d\u3068\u3042\u308a\u307e\u3059\u3002",
    )
...
def main() -> None:
    ...
    page_title = f"JLPT N4 1-5\u307e\u3068\u3081\u30c6\u30b9\u30c8\uff0830\u5206\u30fb{total}\u554f\uff09"
    ...
    v1 = SOURCES[0].read_text(encoding="utf-8")
    end_head = v1.index("</head>") + len("</head>")
    head = v1[:end_head]
    head = head.replace(
        "JLPT N4 確認テスト（10分・10問）</title>",
        f"{page_title}</title>",
    )
