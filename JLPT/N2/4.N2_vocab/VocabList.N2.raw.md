...
JLPT N2 Vocab List
This is not a cumulative list. (It doesn't contain the vocab needed by JLPT N3
and below).
...
to keep in custody,to receive on deposit,to take charge
| 預かる  | あずかる  |     |
| ---- | ----- | --- |
of
...
grateful,thankful,welcome,appreciated,evoking
| 有難い  | ありがたい  |     |
| ---- | ------ | --- |
gratitude
| 在る  | ある  |     |
...
more and more,all the more,increasingly,at last,beyond
いよいよ
|     |     | doubt            |
| --- | --- | ---------------- |
...
yes or no,existence,flag indicator (comp),presence or
| 有無  | うむ  |     |
| --- | --- | --- |
absence marker
| 埋める  | うめる  |     |
...
great,celebrated,eminent,terrible,awful,famous,remark
| 偉い  | えらい  |     |
| --- | ---- | --- |
able,excellent
...
to stop,to restrain,to seize,to repress,to suppress,to
| 押える  | おさえる  |     |
| ---- | ----- | --- |
press down
...
| ----- | ----- | ---------------------------- |
smartly dressed,someone smartly dressed,fashion-
おしゃれ
|     |          | conscious                     |
| --- | -------- | ----------------------------- |
...
happy event,matter for congratulation,auspicious
おめでたい
|     |     | event,pregnancy  |
| --- | --- | ---------------- |
思い掛けな
...
writing down,putting on record,recording,making a note
| 書留  | かきとめ  |     |
| --- | ----- | --- |
of,registration (of mail)
| 書取  | かきとり  | dictation  |
| --- | ----- | ---------- |
| 垣根  | かきね   | hedge      |
| 掻く  | かく    |            |
...
to be piled up,lie on top of one another,overlap each
| 重なる  | かさなる  |     |
| ---- | ----- | --- |
other
to pile up,to put something on another,to heap up,to
| 重ねる  | かさねる  |     |
| ---- | ----- | --- |
add,to repeat
| 飾り  | かざり  |     |
...
| 瓦   | かわら  | roof tile  |
| --- | ---- | ---------- |
(v5r,vi) to take the place of,to relieve,to be substituted
| 代る  | かわる  |     |
| --- | ---- | --- |
for
...
closed (e.g. store),business
| 休業  | きゅうぎょう  |     |
| --- | ------- | --- |
suspended,shutdown,holiday
| 休講  | きゅうこう  |     |
| --- | ------ | --- |
lecture cancelled
...
| --- | --- | --- |
nail
to punctuate,to cut off,to mark off,to stop,to put an end
| 区切る  | くぎる  |     |
| ---- | ---- | --- |
to
| 櫛   | くし    | comb    |
...
achievements,merit,meritorious service,meritorious
| 功績  | こうせき  |     |
| --- | ----- | --- |
deed
...
personal expenses,pocket money,spending
| 小遣い  | こづかい  |     |
| ---- | ----- | --- |
money,incidental expenses,allowance
...
your pardon,declining
| 御免  | ごめん  |     |
| --- | ---- | --- |
(something),dismissal,permission
...
deduction,subtraction,balance,ebb and flow,rise and
| 差し引き  | さしひき  |     |
| ----- | ----- | --- |
fall
...
disappointed love,broken heart,unrequited love,be
| 失恋  | しつれん  |     |
| --- | ----- | --- |
lovelorn
...
| --- | ------ | --------------------- |
high and low,up and down,unloading and
| 上下  | じょうげ  |     |
| --- | ----- | --- |
loading,praising and blaming
...
| 成立  | せいりつ  |     |
| --- | ----- | --- |
existence,arrangements,establishment,completion
...
| ---- | ----- | --------------------------- |
by all means (with sense of not taking no for an
ぜひとも
|     |      | answer)                |
| --- | ---- | ---------------------- |
...
| --- | --- | ---------------------- |
around,throughout,front and back,before and
| 前後  | ぜんご  |     |
| --- | ---- | --- |
...
to belong to,to come under,to be affiliated with,to be
| 属する  | ぞくする  |     |
| ---- | ----- | --- |
subject to
...
to become complete,to be equal,to be all present,to
| 揃う  | そろう  |     |
| --- | ---- | --- |
gather
...
| --- | ---- | ------------------------------- |
to compare,to liken,to speak figuratively,to illustrate,to
| 例える  | たとえる  |     |
| ---- | ----- | --- |
use a simile
...
to bring near,to put close,to let come near,to associate
| 近付ける  | ちかづける  |     |
| ----- | ------ | --- |
with
...
fixed number of regular personnel,capacity (of boat,
| 定員  | ていいん  |     |
| --- | ----- | --- |
etc.)
...
| --- | ----- | ----------------------- |
in and out,coming and going,free association,income
| 出入り  | でいり  |     |
| ---- | ---- | --- |
and expenditure,debits and credit
...
(1) to be finished,to be ready,by definition,(2) to be
| 出来上がる  | できあがる  |     |
| ------ | ------ | --- |
very drunk
...
(1) irresponsible utterance,nonsense,nonsensical,(2)
でたらめ
|     |       | random  |
| --- | ----- | ------- |
| 手帳  | てちょう  |         |
...
| ---- | ---- | ------------------------------------ |
to remove,to take away,to dislodge,to put something
| 退ける  | どける  |     |
| ---- | ---- | --- |
out of the way
| 床の間  | とこのま    | alcove  |
...
to be prepared,to be in order,to be put in order,to be
| 整う  | ととのう  |     |
| --- | ----- | --- |
arranged
| 留まる  | とどまる  |     |
...
| ---- | ---- | ---------------------------- |
anyhow,anyway,somehow or other,generally
ともかく
...
| --- | ----- | --- |
agenda
dull (e.g. a knife),thickheaded,slow (opposite of
| 鈍い  | にぶい  |     |
| --- | ---- | --- |
fast),stupid
...
to be disconnected,to get out of place,to be off,to be
| 外れる  | はずれる  |     |
| ---- | ----- | --- |
out (e.g. of gear)
|     | パターン  | pattern  |
...
| --- | ---- | --- |
judge,judiciary
reflection,reconsideration,introspection,meditation,cont
| 反省  | はんせい  |     |
| --- | ----- | --- |
emplation
...
引っ繰り返
to turn over,to overturn,to knock over,to upset,to turn
ひっくりかえす
| す   |     | inside out  |
| --- | --- | ----------- |
引っ繰り返
to be overturned,to be upset,to topple over,to be
ひっくりかえる
| る     |       | reversed                                   |
| ----- | ----- | ------------------------------------------ |
...
| --- | --- | -------------------------- |
railway crossing,level crossing,starting
| 踏切  | ふみきり  |     |
| --- | ----- | --- |
...
(going) side by side,concurrent,abreast,at the same
| 並行  | へいこう  |     |
| --- | ----- | --- |
time
...
| ---- | ----- | ---------------------------------- |
(1) farm (livestock),(2) pasture land,meadow,grazing
| 牧場  | ぼくじょう  |     |
| --- | ------ | --- |
land
...
| --- | ---- | ------------------------------- |
to be mixed,to be blended with,to associate with,to
| 混ざる  | まざる  |     |
| ---- | ---- | --- |
mingle with,to join
to be mixed,to be blended with,to associate with,to
...
(1) to drive,to pass through,(2) to evade,to hide,(3) to
| 潜る  | もぐる  |     |
| --- | ---- | --- |
dive (into or under water),to go undergroun
もしかしたら
...
to lean against,to lean on,to recline on,to lie heavy (on
もたれる
|     |      | the stomach)  |
| --- | ---- | ------------- |
|     | モダン  | modern        |
...
| --- | ------ | ------------------- |
to attack (an enemy),to beat,to do away with,to finish
やっつける
|     |      | off       |
| --- | ---- | --------- |
| 家主  | やぬし  | landlord  |
...
shop which handles Western-style apparel and
| 洋品店  | ようひんてん  |     |
| ---- | ------- | --- |
accessories
...
(1) to disgrace,to dishonour,(2) to pollute,to
| 汚す  | よごす  |     |
| --- | ---- | --- |
contaminate,to soil,to make dirty,to stain
...
| 分る   | わかる   |                                |
to be understood
to branch off,to diverge from,to fork,to split,to
| 分かれる  | わかれる  |     |
| ----- | ----- | --- |
dispense,to scatter,to divide into
